<template>
  ...
  <div class="lasted_comments_container">
    ...
    export default {
      ...
      methods:{
        ...
        /*moreComments:function(){
          ...
          request.send('idCode='+this.$store.state.idCode+"&index="+this.comment_list.length+"&comments_num="+this.comments_num);
          this.$nextTick(()=>{
        ...
        getComments:function () {
          this.is_load=false;
          let request=new XMLHttpRequest();
          request.open('POST',this.$store.state.request_link+'/comment/newComment');
