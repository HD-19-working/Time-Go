<template>
  ...
  <div class="negative_comments_container">
    ...
    export default {
      ...
      methods:{
        ...
        getComments:function () {
          this.is_load=false;
          let request=new XMLHttpRequest();
          request.open('POST',this.$store.state.request_link+'/comment/badComment');
